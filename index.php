...
<section class="section">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 mb-4">
					<div class="post-entry-alt">
						...
						<div class="excerpt">
							...
							<h2><a href="detail.php">Startup vs corporate: What job suits you best?</a></h2>
							<div class="post-meta align-items-center text-left clearfix">
								<figure class="author-figure mb-0 me-3 float-start"><img src="assets/landing/mages/person_2.jpg" alt="Image" class="img-fluid"></figure>
								<span class="d-inline-block mt-1">By <a href="#">David Anderson</a></span>
								<span>&nbsp;-&nbsp; July 19, 2019</span>
							</div>
				...
				<div class="col-lg-4 mb-4">
					<div class="post-entry-alt">
						<a href="detail.php" class="img-link"><img src="images/img_1_horizontal.jpg" alt="Image" class="img-fluid"></a>
						<div class="excerpt">
				...
				<div class="col-lg-4 mb-4">
					<div class="post-entry-alt">
						<a href="detail.php" class="img-link"><img src="images/img_4_horizontal.jpg" alt="Image" class="img-fluid"></a>
						<div class="excerpt">
				...
				<div class="col-lg-4 mb-4">
					<div class="post-entry-alt">
						<a href="detail.php" class="img-link"><img src="images/img_3_horizontal.jpg" alt="Image" class="img-fluid"></a>
						<div class="excerpt">
