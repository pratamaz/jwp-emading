...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="index.php">Manajemen Artikel</a> /</span> Ubah Data</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="judul_artikel" class="form-control" id="exampleFormControlInput1" placeholder="Judul Artikel" value="<?= $data['judul_artikel']; ?>" required />
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    if ($data['header'] != '') { ?>
                                        <a href="../files/<?= $data['header']; ?>" target="_blank">
                                            <img src="../files/<?= $data['header']; ?>" class="img-thumbnail rounded" style="max-width: 240px;" alt="">
                                        </a>
                                    <?php
                                    } else {
