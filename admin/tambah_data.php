...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="index.php">Manajemen Artikel</a> /</span> Tambah Data</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="judul_artikel" class="form-control" id="exampleFormControlInput1" placeholder="Judul Artikel" required />
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-lg-3">
                                <div class="col-md mb-3">
                                    ...
                                    <div class="form-check">
                                        <input name="status_publish" class="form-check-input" type="radio" value="draft" id="defaultRadio2" checked="">
